...
_BRIDGE_REGISTRY: List[Dict[str, str]] = [
    ...
    {"name": "aviation",   "module": "src.bridges.aviation_disruption_bridge", "class": "AviationDisruptionBridge"},
    ...
    {"name": "gcp",        "module": "src.bridges.gcp_consciousness_bridge","class": "GCPConsciousnessBridge"},
