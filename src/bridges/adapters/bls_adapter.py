#!/usr/bin/env python3
"""Adapter for Bureau of Labor Statistics release bridge."""
...
class BLSAdapter(BaseBridge):
    ...
    def _get_inner(self):
        if self._inner is None:
            ...
            self._inner = BLSReleaseBridge(repo_root=self.repo_root)
        return self._inner
    ...
    def fetch(self) -> Dict[str, Any]:
        try:
            ...
            logger.warning("BLSAdapter fetch failed: %s", e)
