#!/usr/bin/env python3
"""Adapter for White House policy bridge."""
...
class WhitehouseAdapter(BaseBridge):
    source = "whitehouse_policy"
    ...
    def _get_inner(self):
        if self._inner is None:
            ...
            self._inner = WhiteHousePolicyBridge(repo_root=self.repo_root)
        return self._inner
    ...
    def fetch(self) -> Dict[str, Any]:
        try:
            ...
            logger.warning("WhitehouseAdapter fetch failed: %s", e)
