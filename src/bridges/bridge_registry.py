...
class BridgeRegistry:
    ...
    DEFAULT_SPECS: Dict[str, BridgeRegistrySpec] = {
        ...
        # DISABLED 2026-03-21: zero trade value
        ...
        "options_flow_bridge": BridgeRegistrySpec(
            name="options_flow_bridge",
            aliases=("options_flow_bridge", "options_flow"),
            module_path="src.bridges.options_flow_bridge",
            class_name="OptionsFlowBridge",
            preferred_methods=("collect", "poll"),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.8,
            default_freshness_ttl_minutes=15,
        ),
        "vix_term_structure_bridge": BridgeRegistrySpec(
            name="vix_term_structure_bridge",
            aliases=("vix_term_structure_bridge", "vix_term_structure"),
            module_path="src.bridges.vix_term_structure_bridge",
            class_name="VixTermStructureBridge",
            preferred_methods=("collect", "poll"),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.8,
            default_freshness_ttl_minutes=30,
        ),
        "narrative_velocity_bridge": BridgeRegistrySpec(
            name="narrative_velocity_bridge",
            aliases=("narrative_velocity_bridge", "narrative_velocity"),
            module_path="src.bridges.narrative_velocity_bridge",
            class_name="NarrativeVelocityBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_3_research",
            default_trust_weight=0.5,
            default_freshness_ttl_minutes=30,
        ),
        "cds_sovereign_bridge": BridgeRegistrySpec(
            name="cds_sovereign_bridge",
            aliases=("cds_sovereign_bridge", "cds_sovereign"),
            module_path="src.bridges.cds_sovereign_bridge",
            class_name="CDSSovereignBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.8,
            default_freshness_ttl_minutes=1440,
        ...
        "insider_trading_bridge": BridgeRegistrySpec(
            name="insider_trading_bridge",
            aliases=("insider_trading_bridge", "insider_trading", "sec_form4"),
            module_path="src.bridges.insider_trading_bridge",
            class_name="InsiderTradingBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_1_official",
            default_trust_weight=1.0,
            default_freshness_ttl_minutes=1440,
        ),
        "stocktwits_sentiment_bridge": BridgeRegistrySpec(
            name="stocktwits_sentiment_bridge",
            aliases=("stocktwits_sentiment_bridge", "stocktwits_sentiment", "stocktwits"),
            module_path="src.bridges.stocktwits_sentiment_bridge",
            class_name="StockTwitsSentimentBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_3_research",
            default_trust_weight=0.5,
            default_freshness_ttl_minutes=60,
        ),
        "earnings_calendar_bridge": BridgeRegistrySpec(
            name="earnings_calendar_bridge",
            aliases=("earnings_calendar_bridge", "earnings_calendar", "earnings"),
            module_path="src.bridges.earnings_calendar_bridge",
            class_name="EarningsCalendarBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.8,
            default_freshness_ttl_minutes=360,
        ),
        "analyst_ratings_bridge": BridgeRegistrySpec(
            name="analyst_ratings_bridge",
            aliases=("analyst_ratings_bridge", "analyst_ratings", "analyst_consensus"),
            module_path="src.bridges.analyst_ratings_bridge",
            class_name="AnalystRatingsBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.8,
            default_freshness_ttl_minutes=360,
        ),
        "unusual_options_bridge": BridgeRegistrySpec(
            name="unusual_options_bridge",
            aliases=("unusual_options_bridge", "unusual_options", "unusual_options_activity"),
            module_path="src.bridges.unusual_options_bridge",
            class_name="UnusualOptionsBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.8,
            default_freshness_ttl_minutes=15,
        ),
        "polymarket_bridge": BridgeRegistrySpec(
            name="polymarket_bridge",
            aliases=("polymarket_bridge", "polymarket", "prediction_market"),
            module_path="src.bridges.polymarket_bridge",
            class_name="PolymarketBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.8,
            default_freshness_ttl_minutes=5,
        ),
        "finbert_sentiment_bridge": BridgeRegistrySpec(
            name="finbert_sentiment_bridge",
            aliases=("finbert_sentiment_bridge", "finbert_sentiment", "finbert"),
            module_path="src.bridges.finbert_sentiment_bridge",
            class_name="FinBERTSentimentBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_3_research",
            default_trust_weight=0.5,
            default_freshness_ttl_minutes=30,
        ...
        "technical_analysis_bridge": BridgeRegistrySpec(
            name="technical_analysis_bridge",
            aliases=("technical_analysis_bridge", "technical_analysis", "ta"),
            module_path="src.bridges.technical_analysis_bridge",
            class_name="TechnicalAnalysisBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.7,
            default_freshness_ttl_minutes=15,
        ),
        "social_trending_bridge": BridgeRegistrySpec(
            name="social_trending_bridge",
            aliases=("social_trending_bridge", "social_trending", "social"),
            module_path="src.bridges.social_trending_bridge",
            class_name="SocialTrendingBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_3_research",
            default_trust_weight=0.5,
            default_freshness_ttl_minutes=30,
        ),
        "news_impact_bridge": BridgeRegistrySpec(
            name="news_impact_bridge",
            aliases=("news_impact_bridge", "news_impact", "news"),
            module_path="src.bridges.news_impact_bridge",
            class_name="NewsImpactBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.7,
            default_freshness_ttl_minutes=30,
        ),
        "economic_surprise_bridge": BridgeRegistrySpec(
            name="economic_surprise_bridge",
            aliases=("economic_surprise_bridge", "economic_surprise", "econ_surprise"),
            module_path="src.bridges.economic_surprise_bridge",
            class_name="EconomicSurpriseBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_1_official",
            default_trust_weight=0.9,
            default_freshness_ttl_minutes=360,
        ),
        "equity_screener_bridge": BridgeRegistrySpec(            name="equity_screener_bridge",            aliases=("equity_screener_bridge", "equity_screener", "finviz_screener"),            module_path="src.bridges.equity_screener_bridge",            class_name="EquityScreenerBridge",            preferred_methods=("poll",),            default_source_tier="tier_2_operational",            default_trust_weight=0.6,            default_freshness_ttl_minutes=360,        ),        "google_trends_bridge": BridgeRegistrySpec(            name="google_trends_bridge",            aliases=("google_trends_bridge", "google_trends", "trends"),            module_path="src.bridges.google_trends_bridge",            class_name="GoogleTrendsBridge",            preferred_methods=("poll",),            default_source_tier="tier_3_alternative",            default_trust_weight=0.4,            default_freshness_ttl_minutes=360,        ),
        "finra_short_interest_bridge": BridgeRegistrySpec(
            name="finra_short_interest_bridge",
            aliases=("finra_short_interest_bridge", "finra_short_interest", "short_interest"),
            module_path="src.bridges.finra_short_interest_bridge",
            class_name="FINRAShortInterestBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.8,
            default_freshness_ttl_minutes=360,
        ),
        "cboe_vix_bridge": BridgeRegistrySpec(
            name="cboe_vix_bridge",
            aliases=("cboe_vix_bridge", "cboe_vix", "vix_data"),
            module_path="src.bridges.cboe_vix_bridge",
            class_name="CBOEVixBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.8,
            default_freshness_ttl_minutes=30,
        ),
        "defi_llama_bridge": BridgeRegistrySpec(
            name="defi_llama_bridge",
            aliases=("defi_llama_bridge", "defi_llama", "defi"),
            module_path="src.bridges.defi_llama_bridge",
            class_name="DeFiLlamaBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_3_research",
            default_trust_weight=0.5,
            default_freshness_ttl_minutes=60,
        ),
        "apewisdom_bridge": BridgeRegistrySpec(
            name="apewisdom_bridge",
            aliases=("apewisdom_bridge", "apewisdom", "reddit_trending"),
            module_path="src.bridges.apewisdom_bridge",
            class_name="ApeWisdomBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_3_research",
            default_trust_weight=0.5,
            default_freshness_ttl_minutes=30,
        ),
        "openinsider_bridge": BridgeRegistrySpec(
            name="openinsider_bridge",
            aliases=("openinsider_bridge", "openinsider", "insider_clusters"),
            module_path="src.bridges.openinsider_bridge",
            class_name="OpenInsiderBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_2_operational",
            default_trust_weight=0.8,
            default_freshness_ttl_minutes=1440,
        ),
        "treasury_fiscal_bridge": BridgeRegistrySpec(
            name="treasury_fiscal_bridge",
            aliases=("treasury_fiscal_bridge", "treasury_fiscal", "treasury_yields"),
            module_path="src.bridges.treasury_bridge",
            class_name="TreasuryFiscalBridge",
            preferred_methods=("poll",),
            default_source_tier="tier_1_official",
            default_trust_weight=1.0,
            default_freshness_ttl_minutes=1440,
